using MediatR;using Microsoft.AspNetCore.Mvc;using WhatsBiz.Api.Authorization;using WhatsBiz.Application.Features.Printing;using WhatsBiz.SharedKernel;
namespace WhatsBiz.Api.Controllers;
[ApiController,Route("api/print")]public sealed class PrintController(ISender sender):ControllerBase{
