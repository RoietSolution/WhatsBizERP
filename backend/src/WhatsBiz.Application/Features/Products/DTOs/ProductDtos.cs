...
public sealed record ProductListItemDto(Guid ProductId, string ProductCode, string? Barcode, string ProductName, string CategoryName, string BrandName, string UnitName, decimal PurchasePrice, decimal SellingPrice, decimal GSTPercentage, bool IsActive, string? ImageUrl);

public sealed record ProductDto(Guid ProductId, string ProductCode, string? Barcode, string ProductName, string? ShortDescription, string? LongDescription, Guid CategoryId, string CategoryName, Guid BrandId, string BrandName, Guid UnitId, string UnitName, string? HSNCode, string? SACCode, decimal GSTPercentage, decimal PurchasePrice, decimal SellingPrice, decimal MRP, decimal MinimumStock, decimal MaximumStock, decimal ReorderLevel, decimal? Weight, decimal? Length, decimal? Width, decimal? Height, string? ImageUrl, bool IsBatchManaged, bool IsSerialManaged, bool IsActive);
