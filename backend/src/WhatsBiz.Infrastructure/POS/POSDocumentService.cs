...
public sealed class POSDocumentService(IPrintingService printing, IConfiguration configuration) : IPOSDocumentService
{
    private const string ReceiptCss = """
        .receipt{margin:0 auto;font-family:"Courier New",monospace;line-height:1.3;color:#000;background:#fff}.receipt *{box-sizing:border-box}.receipt-header,.receipt-title,.receipt-center,.receipt-footer{text-align:center}.receipt-logo{display:block;max-width:42mm;max-height:16mm;margin:0 auto 3mm;object-fit:contain}.store-name{margin:0;font-size:18px;font-weight:700}.tagline,.receipt p{margin:1mm 0}.separator{border:0;border-top:1px dashed #000;margin:3mm 0}.receipt-title h1{margin:0;font-size:20px}.meta{display:grid;grid-template-columns:1fr 1fr;gap:1mm 4mm;text-align:left}.meta-row{display:grid;grid-template-columns:max-content minmax(0,1fr);gap:2mm;min-width:0}.meta-row>span:last-child{text-align:right;overflow-wrap:normal;word-break:normal}.meta-wide{grid-column:1/-1}.meta-label{font-weight:700;white-space:nowrap}.items{width:100%;border-collapse:collapse;table-layout:fixed;font-size:11px}.items th,.items td{padding:1.5mm .5mm;text-align:right;vertical-align:top}.items th{border-bottom:1px dashed #000;white-space:nowrap;font-weight:700}.items th:first-child,.items td:first-child{width:29%;padding-left:0;text-align:left;overflow-wrap:normal;word-break:normal}.items th:nth-child(2),.items td:nth-child(2){width:8%}.items th:nth-child(3),.items td:nth-child(3){width:18%}.items th:nth-child(4),.items td:nth-child(4){width:10%}.items th:nth-child(5),.items td:nth-child(5){width:15%}.items th:nth-child(6),.items td:nth-child(6){width:20%;padding-right:0}.items td:not(:first-child){white-space:nowrap}.items .item-name{font-weight:600}.total-row{display:flex;justify-content:space-between;gap:3mm}.grand-total,.total-amount{font-size:18px;font-weight:700}.amount-words{font-weight:700;text-align:center;margin:3mm 0}.feedback-qr{width:30mm;height:30mm;display:block;margin:2mm auto}.receipt-footer{margin-top:3mm}
        .paper-58mm .receipt{width:54mm;max-width:54mm;font-family:"Arial Narrow",Arial,sans-serif;font-size:10px;line-height:1.3}.paper-58mm .receipt-logo{max-width:34mm;max-height:12mm}.paper-58mm .store-name{font-size:16px}.paper-58mm .receipt-title h1{font-size:16px}.paper-58mm .meta{display:block}.paper-58mm .meta-row{display:grid;grid-template-columns:18mm minmax(0,1fr);margin-bottom:.5mm}.paper-58mm .items{display:block;font-size:10.5px}.paper-58mm .items thead{display:none}.paper-58mm .items tbody{display:block}.paper-58mm .items tr{display:grid;grid-template-columns:.65fr 1.15fr .75fr 1fr 1.25fr;padding:1.2mm 0;border-bottom:1px dashed #000}.paper-58mm .items td{display:block;width:auto!important;padding:.45mm .25mm;text-align:right;white-space:nowrap}.paper-58mm .items td:first-child{grid-column:1/-1;width:auto;padding:0 0 .7mm;text-align:left;font-size:11px;font-weight:700;white-space:normal}.paper-58mm .items td:not(:first-child)::before{content:attr(data-label);display:block;margin-bottom:.2mm;font-size:8px;font-weight:700;color:#222}.paper-58mm .items td:nth-child(2){padding-left:0;text-align:left}.paper-58mm .items td:nth-child(6){padding-right:0;font-weight:700}.paper-58mm .grand-total,.paper-58mm .total-amount{font-size:15px}.paper-58mm .feedback-qr{width:22mm;height:22mm}.paper-58mm .separator{margin:2mm 0}
        .paper-80mm .receipt{width:72mm;max-width:72mm;font-size:12px}.paper-80mm .items{font-size:10.5px}
    ...
    public string InvoiceHtml(SalesInvoice invoice, string paper, POSInvoicePrintContext context)
    {
        ...
        var body = new StringBuilder($"""
            ...
            <main class="receipt">
              ...
              <hr class="separator" />
              <table class="items"><thead><tr><th>Item</th><th>Qty</th><th>Rate</th>{gstHeaders}<th>Amount</th></tr></thead><tbody>
        """);
