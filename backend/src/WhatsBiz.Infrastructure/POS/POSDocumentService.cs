...
public sealed class POSDocumentService(IPrintingService printing, IConfiguration configuration) : IPOSDocumentService
{
    private const string ReceiptCss = """
        .receipt{margin:0 auto;font-family:"Courier New",monospace;line-height:1.25;color:#000;background:#fff}.receipt *{box-sizing:border-box}.receipt-header,.receipt-title,.receipt-center,.receipt-footer{text-align:center}.receipt-logo{display:block;max-width:42mm;max-height:16mm;margin:0 auto 3mm;object-fit:contain}.store-name{margin:0;font-size:18px;font-weight:700}.tagline,.receipt p{margin:1mm 0}.separator{border:0;border-top:1px dashed #000;margin:3mm 0}.receipt-title h1{margin:0;font-size:20px}.invoice-number{font-size:16px;font-weight:700}.meta{display:grid;grid-template-columns:1fr 1fr;gap:1mm 4mm;text-align:left}.meta-row{display:flex;justify-content:space-between;gap:2mm}.meta-label{font-weight:700}.items{width:100%;border-collapse:collapse;table-layout:fixed;font-size:11px}.items th,.items td{padding:1mm 0;text-align:right;vertical-align:top;overflow-wrap:anywhere}.items th{border-bottom:1px dashed #000}.items th:first-child,.items td:first-child{width:28%;text-align:left}.items th:nth-child(2),.items td:nth-child(2){width:9%}.items th:nth-child(3),.items td:nth-child(3){width:15%}.items th:nth-child(4),.items td:nth-child(4),.items th:nth-child(5),.items td:nth-child(5){width:14%}.items th:nth-child(6),.items td:nth-child(6){width:20%}.total-row{display:flex;justify-content:space-between;gap:3mm}.grand-total,.total-amount{font-size:18px;font-weight:700}.amount-words{font-weight:700;text-align:center;margin:3mm 0}.feedback-qr{width:30mm;height:30mm;display:block;margin:2mm auto}.receipt-footer{margin-top:3mm}
        .paper-58mm .receipt{width:54mm;max-width:54mm;font-size:9px}.paper-58mm .receipt-logo{max-width:34mm;max-height:12mm}.paper-58mm .store-name{font-size:14px}.paper-58mm .receipt-title h1{font-size:14px}.paper-58mm .invoice-number{font-size:11px}.paper-58mm .meta{display:block}.paper-58mm .meta-row{white-space:normal}.paper-58mm .items{font-size:8px}.paper-58mm .items th,.paper-58mm .items td{padding:.6mm .2mm}.paper-58mm .grand-total,.paper-58mm .total-amount{font-size:13px}.paper-58mm .feedback-qr{width:22mm;height:22mm}.paper-58mm .separator{margin:2mm 0}
        .paper-80mm .receipt{width:72mm;max-width:72mm;font-size:12px}
