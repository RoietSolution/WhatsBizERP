...
{
    public static readonly IReadOnlyCollection<string> All = [Product.View, Product.Create, Product.Edit, Product.Delete, Supplier.View, Supplier.Create, Supplier.Edit, Supplier.Delete, Customer.View, Customer.Create, Customer.Edit, Customer.Delete, Warehouse.View, Warehouse.Create, Warehouse.Edit, Warehouse.Delete, Purchase.View, Purchase.Create, Purchase.Approve, Inventory.View, Inventory.Adjust, Inventory.Transfer, Inventory.Reserve, POS.View, POS.Create, POS.Edit, POS.Return, POS.Void, POS.Discount, Sales.View, Sales.Create, Sales.Approve, Reports.View, Settings.Manage, Users.Manage, Roles.Manage, PermissionsManagement.Manage];
