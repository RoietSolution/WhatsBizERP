using System.Text;using FluentAssertions;using WhatsBiz.Application.Features.Printing;using WhatsBiz.Infrastructure.Printing;
namespace WhatsBiz.Tests.Printing;
public sealed class PrintingServiceTests{private readonly PrintingService service=new();
[Theory][InlineData("CODE128","ABC-123")][InlineData("EAN13","5901234123457")][InlineData("EAN8","96385074")][InlineData("UPC","036000291452")][InlineData("CODE39","ABC123")]
