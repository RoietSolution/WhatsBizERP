...
export const routes:Routes=[
 ...
 {path:'',canActivate:[authGuard],loadComponent:()=>import('./layout/main-layout/main-layout.component').then(m=>m.MainLayoutComponent),children:[
  ...
  {path:'reports',canActivate:[permissionGuard],data:gstView,loadComponent:()=>import('./features/reports/reports-center.component').then(m=>m.ReportsCenterComponent)},
  ...
  {path:'admin',canActivate:[permissionGuard],data:adminView,loadComponent:()=>import('./features/administration/administration-hub.component').then(m=>m.AdministrationHubComponent)},
