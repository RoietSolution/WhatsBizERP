...
describe('PaymentSettingsComponent',()=>{
  ...
  beforeEach(async()=>{await TestBed.configureTestingModule({imports:[PaymentSettingsComponent],providers:[{provide:PaymentsApiService,useValue:api}]}).compileComponents();fixture=TestBed.createComponent(PaymentSettingsComponent);fixture.detectChanges();});
